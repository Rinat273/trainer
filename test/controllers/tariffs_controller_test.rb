...
class TariffsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tariff" do
    assert_difference("Tariff.count") do
      post tariffs_url, params: { tariff: { active_tariff_id: @tariff.active_tariff_id, price: @tariff.price, title: @tariff.title } }
    end
  ...
  test "should update tariff" do
    patch tariff_url(@tariff), params: { tariff: { active_tariff_id: @tariff.active_tariff_id, price: @tariff.price, title: @tariff.title } }
