class TariffsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tariff.save
        format.html { redirect_to tariff_url(@tariff), notice: "Tariff was successfully created." }
  ...
  def update
    respond_to do |format|
      if @tariff.update(tariff_params)
        format.html { redirect_to tariff_url(@tariff), notice: "Tariff was successfully updated." }
  ...
  private
    ...
    def tariff_params
      params.require(:tariff).permit(:title, :price, :active_tariff_id)
    end
end
